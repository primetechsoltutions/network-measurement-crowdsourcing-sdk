...
internal interface NetworkRepository {
    suspend fun postNetworkData(request: NetworkDataRequest): Response<NetworkDataResponse>
    suspend fun postNetworkDataLogs(wrapper: LogDataWrapper): Response<Unit>
