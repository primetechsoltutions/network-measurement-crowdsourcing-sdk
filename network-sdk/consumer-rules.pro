...
## Ensure classes remain in com.ptsl.crowdsourcing_network_sdk.* namespace
#-keeppackagenames com.ptsl.crowdsourcing_network_sdk.**
#-repackageclasses 'com.ptsl.crowdsourcing_network_sdk'
